...
```{r}
colnames(pros_dat)
pros_svi1_mat <- pros_dat[ pros_dat[ ,"svi"] ==  1, -5]
(n <- nrow(pros_svi1_mat))

pros_svi0_mat <- pros_dat[ pros_dat[ ,"svi"] ==  0, -5]
(m <- nrow(pros_svi0_mat))

var1_svi0_vec <- pros_dat[ pros_dat[ ,"svi"] ==  0, 1]
m <- length(var1_svi1_vec)

sqrt(var(x = var1_svi1_vec) / n + var(x = var1_svi0_vec) / m)
