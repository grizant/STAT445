...
1. Please log in the your workstation.
2. Open the RStudio application on your machine.
3. Open [24_model_checking_fake_data.Rmd](https://github.com/grizant/STAT445/blob/master/meeting_agendas/24_model_checking_fake_data.Rmd) from website so that you can work along the lecture.
4. Open [lab_09_models.Rmd](https://github.com/grizant/STAT445/blob/master/labs/lab_08_monte_carlo.Rmd) to have the lab available.
