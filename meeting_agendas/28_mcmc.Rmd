...
3) Students will be able to use statistical computing techniques to make inferences in Lab 10

## II. Markov Chain simulation

***Opening remark: MCMC relies on clever use of ratios of probability density functions.***
...
**The algorithm is designed so that the stationary distribution of the chain is $f$.ce**
...
*Note: Roberts, Gelman, and Gilks (1997) recommend that the rejection rates in the range $[0.15, 0.5]$ for good performance.*
...
## IV. Lab 10, time permitting

## V. Summary

Explain simply how MCMC works in 1-3 sentences.
